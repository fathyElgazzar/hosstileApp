          ...
          <div class="store-item-box">
            ...
            <div class="store-item-text-box">
              ...
              <p class="store-item-price">$<?php echo $data['price']; ?> USD</p>
                ...
                <a href="edit.php?edit=<?php echo $data['pid']?>">EDIT</a>
                </button>
                <button class="btn btn-add">
                <a href="mainadmin.php?delete=<?php echo $data['pid']?>">DELETE</a>
                </button>
            </div>
          </div>
          <?php } ?>
      ...
      <div class="footer-box">
        ...
        <div class="footer-text-box">
          <div class="footer-text">
            ...
            <span class="footer-name">Tony anis</span> and
            <span class="footer-name">Maya Hesham</span>
          </div>
        </div>
      </div>
    </footer>
